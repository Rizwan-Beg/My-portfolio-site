  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <div className="w-32 h-1 bg-white rounded-full mx-auto my-2"></div>
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A collection of my work experience and professional roles
        </p>
      </div>
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="w-16 h-16 bg-white rounded-md overflow-hidden">
                  <img src={experience.img} alt={experience.company}></img>
                </div>
                {/* roll , company name and date */}
