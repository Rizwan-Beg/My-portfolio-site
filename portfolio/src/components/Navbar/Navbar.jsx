...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-5 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
    isScrolled ? "bg-[#1a1a1a] bg-opacity-50 backdrop-blur-md shadow-md"  : "bg-transparent"}`}> 
      <div className="text-white py-3 flex justify-between items-center">
        <div className="text-lg font-semibold cursor-pointer">
          <span className="text-[#8245ec] ">&lt;</span>
          <span className="text-white">Rizwan</span>
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Beg</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <a href="https://github.com/rizwan-beg" target="_blank" rel="noopener noreferrer">
            <FaGithub className="text-gray-300 hover:text-[#8245ec] cursor-pointer" />
          </a>
          <a href="https://www.linkedin.com/in/rizwan-beg/" target="_blank" rel="noopener noreferrer">
